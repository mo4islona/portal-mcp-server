...
export const ETHEREUM_LABELS: ContractLabel[] = [
  ...
  // DEXs
  { address: "0x7a250d5630b4cf539739df2c5dacb4c659f2488d", name: "Uniswap V2 Router", category: "dex", website: "uniswap.org" },
  { address: "0xe592427a0aece92de3edee1f18e0157c05861564", name: "Uniswap V3 Router", category: "dex", website: "uniswap.org" },
  { address: "0xdef1c0ded9bec7f1a1670819833240f027b25eff", name: "0x Exchange Proxy", category: "dex", website: "0x.org" },

  // Lending
  { address: "0x7d2768de32b0b80b7a3454c06bdac94a69ddc7a9", name: "Aave V2 Lending Pool", category: "lending", website: "aave.com" },
  { address: "0x87870bca3f3fd6335c3f4ce8392d69350b4fa4e2", name: "Aave V3 Pool", category: "lending", website: "aave.com" },
];
...
export const ARBITRUM_LABELS: ContractLabel[] = [
  ...
  // DEXs
  { address: "0xe592427a0aece92de3edee1f18e0157c05861564", name: "Uniswap V3 Router", category: "dex", website: "uniswap.org" },
  { address: "0x1b02da8cb0d097eb8d57a175b88c7d8b47997506", name: "SushiSwap Router", category: "dex", website: "sushi.com" },
];
...
export const OPTIMISM_LABELS: ContractLabel[] = [
  ...
  // DEXs
  { address: "0xe592427a0aece92de3edee1f18e0157c05861564", name: "Uniswap V3 Router", category: "dex", website: "uniswap.org" },
  { address: "0x9c12939390052919af3155f41bf4160fd3666a6f", name: "Velodrome Router", category: "dex", website: "velodrome.finance" },
];
...
export const POLYGON_LABELS: ContractLabel[] = [
  ...
  // DEXs
  { address: "0xe592427a0aece92de3edee1f18e0157c05861564", name: "Uniswap V3 Router", category: "dex", website: "uniswap.org" },
  { address: "0xa5e0829caced8ffdd4de3c43696c57f7d7a678ff", name: "QuickSwap Router", category: "dex", website: "quickswap.exchange" },
];
